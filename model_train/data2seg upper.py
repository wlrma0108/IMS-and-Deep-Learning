...
IMAGE_DIR = r'C:\Users\hojoo\Desktop\ims\dataset2_aug\dataset2_FlipRotate'
MASK_DIR  = r'C:\Users\hojoo\Desktop\ims\dataset2_aug\dataset2_FlipRotate_masks'
IMAGE_SIZE = 256
NUM_SAMPLES = 2700
BATCH_SIZE = 8
EPOCHS = 50
...
if __name__ == '__main__':
    ...
    train_ds = CovidDataset(IMAGE_DIR, MASK_DIR, train)
    val_ds   = CovidDataset(IMAGE_DIR, MASK_DIR, val)
    test_ds  = CovidDataset(IMAGE_DIR, MASK_DIR, test)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(f'Epoch {epoch}/{EPOCHS} | Train Loss: {train_loss:.4f} | Val Loss: {val_loss:.4f} | F1: {val_f1:.4f} | mIoU: {val_miou:.4f}')

    torch.save(model.state_dict(), 'ela_unet_covid_segmentation.pt')
